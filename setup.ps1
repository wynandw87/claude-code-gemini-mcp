# Google Gemini MCP Server Setup Script for Windows
# Usage: .\setup.ps1 -ApiKey "YOUR_GEMINI_API_KEY"
...
Write-Host "Google Gemini MCP Server Setup" -ForegroundColor Blue
Write-Host ""
...
claude mcp add -s user gemini -e "GEMINI_API_KEY=$ApiKey" -- node $serverPath

Write-Host ""
Write-Host "Setup complete!" -ForegroundColor Green
Write-Host ""
Write-Host "You can now use Gemini in Claude Code from any directory!" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  - search_with_thinking - Extended reasoning" -ForegroundColor Gray
...
Write-Host "  - google_maps          - Location queries" -ForegroundColor Gray
